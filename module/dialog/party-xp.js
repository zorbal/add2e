export class Add2ePartyXP extends FormApplication {

    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["add2e", "dialog", "party-xp"],
            template: "systems/add2e/templates/apps/party-xp.html",
            width: 280,
            height: 400,
            resizable: false,
        });
     ...
     */
    get title() {
        return game.i18n.localize("ADD2E.dialog.xp.deal");
    }
     ...
     */
    getData() {
        const actors = this.object.entities.filter(e => e.data.type === "character" && e.data.flags.add2e && e.data.flags.add2e.party === true);
        let data = {
            actors: actors,
            data: this.object,
            config: CONFIG.ADD2E,
